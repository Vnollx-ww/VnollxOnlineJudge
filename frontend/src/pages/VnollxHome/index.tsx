import { ArrowRight, Code, CheckCircle, Terminal, Cpu, Globe, Star, Users } from 'lucide-react';
import { Link } from 'react-router-dom';

const CodeArenaHome: React.FC = () => {
  return (
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold tracking-tight text-gray-900">CodeArena</span>
          </div>
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-600">
            <Link to="/problems" className="hover:text-blue-600 transition-colors">题库</Link>
            <Link to="/competitions" className="hover:text-blue-600 transition-colors">竞赛</Link>
            <Link to="/ranklist" className="hover:text-blue-600 transition-colors">排名</Link>
          </div>
          <div className="flex items-center gap-4">
            <Link to="/login" className="text-sm font-medium text-gray-600 hover:text-blue-600 transition-colors">
              登录
            </Link>
            <Link to="/register" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors shadow-sm hover:shadow-md">
              注册
            </Link>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 max-w-xl leading-relaxed">
                CodeArena 提供海量编程题目、实时评测系统和活跃的技术社区。无论你是初学者还是算法大神，这里都是你提升技能的最佳场所。
              </p>
              <div className="flex flex-wrap gap-4">
                <Link 
                  to="/problems"
                  className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg font-medium transition-all hover:scale-105 shadow-lg shadow-blue-600/20"
                >
                  开始刷题 <ArrowRight size={18} />
                </Link>
                <Link 
                  to="/problems"
                  className="px-8 py-4 rounded-lg font-medium border border-gray-200 hover:bg-gray-50 text-gray-700 transition-colors"
                >
                  查看题库
                </Link>
              </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">为什么选择 CodeArena？</h2>
      ...
      <section className="py-24 bg-blue-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-blue-100 text-lg mb-10 max-w-2xl mx-auto">
            加入 CodeArena，开启你的编程进阶之旅。现在注册，即可免费获取《算法面试通关手册》。
          </p>
          <Link 
            to="/register"
            className="inline-block bg-white text-blue-600 px-10 py-4 rounded-full font-bold text-lg hover:bg-blue-50 transition-colors shadow-2xl shadow-blue-900/20 hover:scale-105 transform duration-200"
          >
            立即免费注册
          </Link>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <p className="text-sm leading-relaxed">
              CodeArena 是全球领先的在线编程学习平台，致力于帮助开发者提升技术能力，通过算法改变世界。
            </p>
          </div>
          <div>
            <h4 className="text-white font-bold mb-6">平台</h4>
            <ul className="space-y-4 text-sm">
              <li><Link to="/problems" className="hover:text-white transition-colors">题库</Link></li>
              <li><Link to="/competitions" className="hover:text-white transition-colors">竞赛</Link></li>
              <li><Link to="/ranklist" className="hover:text-white transition-colors">排名</Link></li>
              <li><Link to="/practices" className="hover:text-white transition-colors">练习</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li><span className="cursor-pointer hover:text-white transition-colors">帮助中心</span></li>
              <li><span className="cursor-pointer hover:text-white transition-colors">社区规范</span></li>
            </ul>
          </div>
          <div>
