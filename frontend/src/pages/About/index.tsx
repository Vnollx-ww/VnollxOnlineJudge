    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="max-w-2xl mx-auto leading-relaxed" style={{ color: 'var(--gemini-text-secondary)' }}>
          AI+智能编程辅助平台 是一个专为程序员打造的智能编程辅助平台。
      ...
      <div className="text-center text-sm" style={{ color: 'var(--gemini-text-disabled)' }}>
        <p className="flex items-center justify-center gap-1">
          Made with <Heart className="w-4 h-4" style={{ color: 'var(--gemini-error)' }} /> by AI+智能编程辅助平台 Team
        </p>
        <p className="mt-2">© 2025 AI+智能编程辅助平台. All rights reserved.</p>
      </div>
    </div>
  );
};
