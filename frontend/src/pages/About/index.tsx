import { Github, Mail, Heart, Code2, Users, Trophy, Shield, FileText, Clock } from 'lucide-react';
    ...
    <div className="space-y-8">
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 rounded-2xl flex items-center justify-center" style={{ backgroundColor: 'var(--gemini-accent)', color: 'var(--gemini-accent-strong)' }}>
        ...
        <div className="space-y-4 text-sm" style={{ color: 'var(--gemini-text-secondary)' }}>
