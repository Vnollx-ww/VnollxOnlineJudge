...
public interface PracticeService {
    PracticeVo createPractice(String title, String description, Boolean isPublic);
    PracticeVo updatePractice(Long id, String title, String description, Boolean isPublic);
