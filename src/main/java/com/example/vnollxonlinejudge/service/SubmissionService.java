...
public interface SubmissionService {
    ...
    void updateSubmissionJudgeStatusBySnowflake(Long snowflakeId, String judgeStatus, Long time, Long memory, String errorInfo, Integer passCount, Integer testCount);
}
